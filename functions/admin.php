...
add_action('wp_dashboard_setup', function() {
	...
	wp_add_dashboard_widget('custom_help_widget', 'Western Region WordPress Theme', function() {
		...
		if(empty($latest_version)){
			$message = '<p>Checking for updates failed. Please visit our <a href="https://github.com/oawest/wp-theme/releases/latest" target="_blank">GitHub</a> to manually check for updates.</p>';
		}
		...
		echo '<p>Welcome to the Western Region WordPress Theme</p>
			...
			<div style="width:100%; text-align:center;"><img src="'.get_template_directory_uri().'/assets/images/logos/logo.jpg" style="max-width:100%; width:150px;"></div>
